...
export declare const BSC_TOKEN_CONTRACTS: Record<string, string>;
export declare const BSC_TOKEN_DECIMALS: Record<string, number>;
 ...
 */
export declare function verifyBscTransfer(receipt: EthTxReceipt, asset: string, receivingAddress: string, expectedAmount: number): BscVerifyResult;
