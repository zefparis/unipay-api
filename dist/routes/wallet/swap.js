...
const getFiatRate = () => Number(env_1.env.FIAT_USD_CDF_RATE ?? '2850') || 2850;
...
const walletSwapRoute = async (fastify) => {
    ...
    fastify.post('/wallet/swap', {
        ...
        fastify.log.info({ walletId: wallet.id, direction, amount, amountOut, feeAmt }, '[swap] completed');
...
exports.default = walletSwapRoute;
