...
const walletP2PRoute = async (fastify) => {
    fastify.post('/wallet/send', {
        schema: {
            body: {
                type: 'object',
        ...
        const transferId = node_crypto_1.default.randomUUID();
        const senderTxId = node_crypto_1.default.randomUUID();
        const recipientTxId = node_crypto_1.default.randomUUID();
        ...
        if (snd?.email) {
            (0, email_1.sendWalletTransferEmail)({
    ...
    fastify.post('/wallet/send-usdt', {
        ...
        const transferId = node_crypto_1.default.randomUUID();
        const senderTxId = node_crypto_1.default.randomUUID();
        const receiverTxId = node_crypto_1.default.randomUUID();
...
exports.default = walletP2PRoute;
