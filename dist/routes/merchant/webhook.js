...
const merchantWebhookRoute = async (fastify) => {
    /* ── GET /v1/merchant/webhook ─────────────────────────────── */
    fastify.get('/merchant/webhook', {
        schema: {
            response: {
                200: {
                    type: 'object',
    ...
    fastify.post('/merchant/webhook', {
        ...
        const webhookSecret = `whsec_${node_crypto_1.default.randomBytes(24).toString('hex')}`;
    ...
    fastify.delete('/merchant/webhook', {
        schema: {
    ...
    fastify.post('/merchant/webhook/test', {
        schema: {
            response: {
                200: {
                    type: 'object',
        ...
        const payload = JSON.stringify({
            ...
            data: {
                transaction_id: `test_${node_crypto_1.default.randomBytes(4).toString('hex')}`,
                status: 'success',
                amount: 1000,
                fee: 40,
                net_amount: 960,
...
exports.default = merchantWebhookRoute;
