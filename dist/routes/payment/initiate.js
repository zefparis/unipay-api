...
const initiateRoute = async (fastify) => {
    fastify.post('/payment/initiate', {
        ...
        if (isSandbox) {
            const mockRef = direction === 'collect'
                ? (0, avada_1.sandboxCollection)(amount).avada_transaction_id
                : (0, avada_1.sandboxPayout)(amount).avada_transaction_id;
