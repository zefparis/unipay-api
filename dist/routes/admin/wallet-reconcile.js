...
const walletReconcileRoute = async (fastify) => {
    ...
    fastify.post('/admin/wallet/reconcile', {
        schema: {
            body: {
                type: 'object',
                required: ['reference'],
        ...
        if (delta > 0) {
            ...
            const { error: balErr } = await fastify.supabase
                ...
                .eq('id', tx.wallet_user_id);
            if (balErr)
                return reply.status(500).send({ error: balErr.message });
        }
...
exports.default = walletReconcileRoute;
//# sourceMappingURL=wallet-reconcile.js.map