...
const walletInspectRoute = async (fastify) => {
    fastify.get('/admin/wallet/inspect/:reference', async (request, reply) => {
        ...
        if (!tx)
            return reply.status(404).send({ error: `Not found: ${reference}` });
        let wallet = null;
...
exports.default = walletInspectRoute;
//# sourceMappingURL=wallet-inspect.js.map